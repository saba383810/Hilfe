/*
 * Copied from https://takap-tech.com/entry/2021/02/02/222406
 */
...
namespace TeamB.Scripts.Common.API
{
    ...
    public static class JsonHelper
    {
        ...
        public static T[] FromJson<T>(string json)
        {
            ...
            // ★ }
            //
            var dummy_json = $"{{\"{DummyNode<T>.ROOT_NAME}\": {json}}}";
        ...
        {
            var json = JsonUtility.ToJson(new DummyNode<T>(collection)); // ダミールートごとシリアル化する
            var start = DummyNode<T>.ROOT_NAME.Length + 4;
