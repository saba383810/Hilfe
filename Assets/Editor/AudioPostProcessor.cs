...
public class AudioPostProcessor : AssetPostprocessor {
  ...
  //全オーディオファイルの設定を更新する
  [MenuItem("Tools/Sabanogames.AudioManager/Update BGM&SE Setting")]
  ...
  /// 全BGMファイルの設定を更新する
  /// </summary>
  [MenuItem("Tools/Sabanogames.AudioManager/Update BGM Setting")]
  ...
  /// 全SEファイルの設定を更新する
  /// </summary>
  [MenuItem("Tools/Sabanogames.AudioManager/Update SE Setting")]
